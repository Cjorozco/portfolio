    ...
    <footer className="bg-gray-950 text-gray-400 border-t border-gray-800">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed">
              Senior Frontend Engineer especializado en React, TypeScript y
              arquitecturas escalables para FinTech y Banca.
            </p>
          </div>
        ...
        <div className="mt-10 pt-6 border-t border-gray-800 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-xs">
            © {currentYear} José Carlos Orozco Medina. Todos los derechos reservados.
          </p>
          <p className="text-xs">
            Hecho con{' '}
